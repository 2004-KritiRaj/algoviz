    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{
                ...
                boxShadow: "0 0 16px rgba(193,232,255,0.3)", flexShrink: 0,
              }}
            >
            ...
            <span
              style={{
                ...
                letterSpacing: "0.15em", color: "#C1E8FF",
                ...
                <button
                  ...
                  style={{
                    ...
                    background: isActive
                      ...
                      : "transparent",
                    border: "none",
                    color: isActive ? "#021024" : "#5483B3",
                    boxShadow: isActive ? "0 2px 12px rgba(84,131,179,0.5)" : "none",
                  ...
                  onMouseEnter={e => {
                    if (!isActive) {
                      ...
                      e.currentTarget.style.background = "rgba(84,131,179,0.2)";
                    }
                  }}
                  onMouseLeave={e => {
                    if (!isActive) {
          ...
          /* GitHub link */
            ...
            href="https://github.com/2004-KritiRaj/algoviz"
            target="_blank"
      ...
      <div style={{ paddingTop: "64px" }}>
        <Routes>
          ...
          <Route path="/binary" element={<BinarySearchVisualizer />} />
